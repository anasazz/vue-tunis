...
<div class="relative bg-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      ...
      <div v-if="!$store.state.isAuthenticated" class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
      ...
      <div v-else class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              ...
              <button @click="hanldeOut()" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-400 hover:bg-red-700" > Lougout</button>
